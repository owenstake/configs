...
class fzf_select(Command):
   ...
   def execute(self):
       ...
       self.fm.notify('starting fzf_select', bad=True)
       ...
       self.fm.notify('fzf exec', bad=True)

       # fzf = self.fm.execute_command('fzf --no-multi', env=env,
       # fzf = self.fm.execute_command('fzf', env=env,
       #                               universal_newlines=True, stdout=subprocess.PIPE)
       fzf = self.fm.execute_command('fzf', stdout=subprocess.PIPE)

       self.fm.notify('fzf communicate', bad=True)
